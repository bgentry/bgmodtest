...
require github.com/bgentry/bgmodtest v0.0.4

require (
	github.com/bgentry/bgmodtest/bgmoddriver v0.0.4 // indirect
	github.com/bgentry/bgmodtest/bgmoddriver/bgmodpgxv5 v0.0.4 // indirect
)
