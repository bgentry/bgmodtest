...
require github.com/bgentry/bgmodtest v0.0.3

require (
	github.com/bgentry/bgmodtest/bgmoddriver v0.0.3 // indirect
	github.com/bgentry/bgmodtest/bgmoddriver/bgmodpgxv5 v0.0.3 // indirect
)
